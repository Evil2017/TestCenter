...
$.fn.pagination.defaults={total:1,pageSize:50,pageNumber:1,pageList:[50,20,30,100],loading:false,buttons:null,showPageList:true,showPageInfo:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh","info"],onSelectPage:function(_d1,_d2){
...
$.ajax({
    type: opts.method, url: opts.url, data: _86e, dataType: "json", traditional:true,success: function (data) {
_86f(data);
},error:function(){
...
break;
    case 13: t.combo('hidePanel'); break;
